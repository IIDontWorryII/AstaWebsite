...
export default function Datenschutz() {
  return (
    <div className="prose prose-neutral max-w-3xl mx-auto px-6 py-12">
      <h1>Datenschutz&shy;erkl&auml;rung</h1>
      <p className="text-sm text-gray-500">Stand: {STAND}</p>
      ...
      <p>netcup GmbH (Deutschland)</p>
      <p>Zus&auml;tzlich setzen wir folgende Auftragsverarbeiter ein:</p>
      <ul>
        <li>
          <strong>Neon</strong> (Neon, Inc.) &ndash; Datenbank zur Speicherung
          von Konto- und Websitedaten. Speicherort: EU (Frankfurt).
          Rechtsgrundlage: Art. 6 Abs. 1 lit. b und f DSGVO.
        </li>
        <li>
          <strong>Cloudflare</strong> (Cloudflare, Inc.) &ndash; Speicherung
          hochgeladener Dateien (z.&nbsp;B. Veranstaltungsbilder,
          PDF-Dokumente). Rechtsgrundlage: Art. 6 Abs. 1 lit. f DSGVO. F&uuml;r
          etwaige Daten&uuml;bermittlungen in die USA bestehen
      ...
      <p>
        Telefon: 02642 932185
        <br />
        E-Mail: rac-asta-vorsitz@rheinahrcampus.de
      </p>
      <p>
      ...
      <p>
        Sofern weitere Cookies und Dienste auf dieser Website eingesetzt werden,
        k&ouml;nnen Sie dies dieser Datenschutzerkl&auml;rung entnehmen.
      </p>
